...
const SignIn: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-custom-gradient">
      ...
      <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-lg w-full max-w-[68rem] h-auto md:h-[40rem]">
        {/* Left Section - Image */}
        ...
        <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
          <h2 className="text-[18px] font-medium text-[#405189] mb-1 font-poppins">Welcome Back!</h2>
          <p className="text-gray-500 mb-6 font-poppins">Sign in to continue to Deal Buddy.</p>

          <form className="flex flex-col space-y-4" onSubmit={signIn}>
            <div>
              <label className="text-[16px] font-normal font-poppins">Username</label>
              <input
                type="text"
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <a href="#" className="text-lg opacity-60 hover:underline">Forgot password?</a>
              </div>
          ...
          <p className="text-center text-sm mt-6 font-poppins">
            ...
            <a href="#" className="text-[#405189] font-extrabold underline">Signup</a>
          </p>
        </div>
      </div>
    </div>
